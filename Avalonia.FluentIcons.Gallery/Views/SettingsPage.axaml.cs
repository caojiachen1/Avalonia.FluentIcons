...
public partial class SettingsPage : UserControl
{
    ...
    private void ApplyLanguage()
    {
        ...
        this.FindControl<TextBlock>("AboutDesc2")!.Text = t("settings.about_desc2");
        this.FindControl<TextBlock>("AboutDesc3")!.Text = t("settings.about_desc3");
        this.FindControl<TextBlock>("RepoButtonText")!.Text = t("settings.repo_button");
        this.FindControl<TextBlock>("WpfuiButtonText")!.Text = t("settings.wpfui_button");
    }
    ...
    {
        OpenUrl("https://github.com/caojiachen1/Avalonia.FluentIcons");
    }

    private void WpfuiButton_Click(object? sender, RoutedEventArgs e)
    {
